...
# Create  github repo via github provider
provider "github" {
  token="XXXXX  You should write your github token  XXXXXX"
}
...
resource "aws_instance" "tf-docker-ec2" {
    ...
    key_name = "myinsctancekey"
    security_groups = ["mysql-docker-sec-gr"]
    tags= {
   ...
   user_data = <<-EOF
          ...
          TOKEN=" XXX You should write your github token XXXX"
          FOLDER="https://$TOKEN@raw.githubusercontent.com/abbabe/bookstore-api/main/"
