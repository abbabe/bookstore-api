...
app.config['MYSQL_DATABASE_USER'] = 'abbabe'
app.config['MYSQL_DATABASE_PASSWORD'] = 'Abbabe_1'
...
def init_bookstore_db():
    ...
    VALUES
        ("Nutuk", "Mustafa Kemal Ataturk", 100 ),
        ("Kumarbaz", "Fyodor Dostoyevski",50),
        ("DEVOPS for Beginners", "Craig Berg", 10);
    """
...
@app.route('/')
def home():
    return " Welcome to ABBABE's Bookstore API Service "
